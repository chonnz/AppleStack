...
enum AppLanguage: String, CaseIterable, Identifiable {
    ...
    func localized(_ value: String) -> String {
        ...
        case "Kill container?": return "强制停止容器？"
        case "This immediately stops the running process inside the container.": return "这会立即停止容器内正在运行的进程。"
        case "Prune unused volumes?": return "清理未使用的卷？"
        case "This removes unused local volumes. Existing containers are not deleted.": return "这会移除未使用的本地卷，不会删除已有容器。"
        case "Prune unused networks?": return "清理未使用的网络？"
        case "This removes unused local networks. Existing containers are not deleted.": return "这会移除未使用的本地网络，不会删除已有容器。"
        case "System template": return "系统模板"
        case "Choose a system": return "选择系统"
        case "AppleStack prepares the selected Linux system automatically.": return "AppleStack 会自动准备选中的 Linux 系统。"
        case "Best for": return "适合"
        case "Recommended": return "推荐"
        case "Best choice for daily development": return "适合日常开发的默认选择"
        case "Use this when older packages are required": return "适合需要旧版软件包的场景"
        case "Stable and lightweight Linux environment": return "稳定轻量的 Linux 环境"
        case "Light": return "轻量"
        case "Standard": return "标准"
        case "Performance": return "高性能"
        case "Configuration": return "配置"
        case "CPU": return "CPU"
        case "Standard is recommended for most local development work.": return "大多数本地开发场景建议使用标准配置。"
        case "Home folder access": return "主目录访问"
        ...
        case "Creating virtual machine...": return "正在创建虚拟机..."
        case "Starting virtual machine...": return "正在启动虚拟机..."
        case "Virtual machine created": return "虚拟机已创建"
        case "Virtual machine is ready": return "虚拟机已可用"
        case "Please enter a machine name.": return "请先填写虚拟机名称。"
        case "System template failed": return "系统模板准备失败"
        case "Start failed after create": return "创建后启动失败"
        ...
        case "Start the machine to access the terminal.": return "启动虚拟机后即可访问终端。"
